    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".body-product__images")) {
                let thumbsSwiper = new swiper_core_Swiper(".images-preview__slider", {
                ...
                new swiper_core_Swiper(".images-product__slider", {
                    modules: [ Navigation, Thumb, Controller, EffectFade ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
...
***************************************************************************** */
        ...
        function setProducts(products, start, limit) {
            ...
            productsArray.forEach(((product, index) => {
                if (index >= start && index < limit + start) {
                    ...
                    if (category === 1) collectionsItems = document.querySelector("#cat-01");
                    if (category === 2) collectionsItems = document.querySelector("#cat-02");
                    if (category === 3) collectionsItems = document.querySelector("#cat-03");
        ...
        function addToCart() {
            ...
            document.querySelector(".body-product__title").innerHTML;
            document.querySelector(".price-product__old") && document.querySelector(".price-product__old").innerHTML;
            document.querySelector(".price-product__value").innerHTML;
            const productsQuantity = document.querySelector(".quantity__input input").value;
            ...
            setTimeout((() => {
                headerCartQuantity.innerHTML = +headerCartQuantity.innerHTML + +productsQuantity;
